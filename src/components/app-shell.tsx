...
function UserProfile({ name, email, onSignOut }: { name: string; email: string; onSignOut: () => Promise<void> }) {
    ...
    <div className="relative">
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          ...
          <span className="block truncate text-[11px] text-ink-tertiary">{email}</span>
        </span>
      </button>
